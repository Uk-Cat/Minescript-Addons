This Mod is an addon to [Minescript](https://modrinth.com/mod/minescript). Minescript is a Minecraft mod that allows you to control/interact with the game using python/pyjinn script created by [Maxuser](https://modrinth.com/user/maxuser).
